...
const translations: Translations = {
  ...
  hero: {
    ...
    date: "2025-12-15 to 2026-01-XX (UTC+0)",
    register_now: "Register Now",
    complete_profile: "Complete Profile",
    my_assets: "My Dashboard",
    explore_leaderboard: "Explore Leaderboard",
...
const translationsZh: Translations = {
  ...
  hero: {
    ...
    date: "2025-12-15 至 2026-01-XX (UTC+0)",
    register_now: "立即报名",
    complete_profile: "完善资料",
    my_assets: "My Dashboard",
    explore_leaderboard: "浏览排行榜",
    create_bot: "创建策略 Bot",
    prize_pool: "总奖池",
    spartans: "参赛勇士",
    top_roi: "最高收益率",
